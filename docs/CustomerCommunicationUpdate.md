# WWW::OpenAPIClient::Object::CustomerCommunicationUpdate
...
**contact_id** | **string** | The contact (customer/supplier) this communication belongs to. References the contact entity. | [optional] 
