...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'trigger_mirror' } = {
        summary => '',
        params => $params,
        returns => 'MirrorTriggerResponse',
        };
}
...
sub trigger_mirror {
    ...
    # parse inputs
    my $_resource_path = '/api/v1/admin/storage/mirror';
    ...
    my $_response_object = $self->{api_client}->deserialize('MirrorTriggerResponse', $response);
