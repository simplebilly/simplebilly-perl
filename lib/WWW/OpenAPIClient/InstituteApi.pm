...
#
package WWW::OpenAPIClient::InstituteApi;
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'institute_status_api' } = {
        summary => '',
        params => $params,
        returns => 'InstituteStatus',
        };
}
# @return InstituteStatus
#
sub institute_status_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/institute/status';
    ...
    my $_response_object = $self->{api_client}->deserialize('InstituteStatus', $response);
