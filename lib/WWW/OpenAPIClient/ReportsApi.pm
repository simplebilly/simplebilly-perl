...
# @param int $page_size  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'bilanz_report_api' } = {
        summary => 'Bilanz (Balance Sheet)',
        params => $params,
        returns => 'BilanzReport',
        };
}
# @return BilanzReport
#
sub bilanz_report_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/reports/bilanz';
    ...
    my $_response_object = $self->{api_client}->deserialize('BilanzReport', $response);
...
# @param int $page_size  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'guv_report_api' } = {
...
sub guv_report_api {
    ...
    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/reports/guv';
    ...
    my $_response_object = $self->{api_client}->deserialize('GuVReport', $response);
    return $_response_object;
}
...
# @param int $page_size  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'kontenansicht_report_api' } = {
...
# @return KontoReport
#
sub kontenansicht_report_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/reports/kontenansicht';
    ...
    my $_response_object = $self->{api_client}->deserialize('KontoReport', $response);
    return $_response_object;
}
...
# @param int $page_size  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'umsatzsteuer_report_api' } = {
        summary => 'Umsatzsteuer-Voranmeldung (VAT report)',
        params => $params,
        returns => 'UmsatzsteuerReport',
        };
}
# @return UmsatzsteuerReport
#
sub umsatzsteuer_report_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/reports/umsatzsteuer';
    ...
    my $_response_object = $self->{api_client}->deserialize('UmsatzsteuerReport', $response);
    return $_response_object;
}
