...
#
package WWW::OpenAPIClient::OffenlegungApi;
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'offenlegung_api' } = {
        summary => '',
        params => $params,
        returns => 'OffenlegungReport',
        };
}
...
sub offenlegung_api {
    ...
    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/offenlegung';
    ...
    my $_response_object = $self->{api_client}->deserialize('OffenlegungReport', $response);
