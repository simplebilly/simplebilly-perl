...
#
package WWW::OpenAPIClient::DatevImportApi;
...
# @param object $body  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'datev_import_api' } = {
        summary => '',
        params => $params,
        returns => 'DatevImportResponse',
        };
}
# @return DatevImportResponse
#
sub datev_import_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/bookkeeping/datev/import';
    ...
    my $_response_object = $self->{api_client}->deserialize('DatevImportResponse', $response);
