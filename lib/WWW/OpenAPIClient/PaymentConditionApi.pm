...
#
package WWW::OpenAPIClient::PaymentConditionApi;
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'list_payment_conditions_api' } = {
        summary => '',
        params => $params,
        returns => 'ARRAY[PaymentCondition]',
        };
}
# @return ARRAY[PaymentCondition]
#
sub list_payment_conditions_api {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/api/v1/payment-conditions';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[PaymentCondition]', $response);
