...
#
package WWW::OpenAPIClient::Object::VoucherCreate;
...
__PACKAGE__->method_documentation({
    ...
    'voucher_type' => {
        datatype => 'VoucherType',
        base_name => 'voucherType',
        description => '',
        format => '',
        read_only => '',
            },
