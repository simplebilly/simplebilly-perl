...
#
package WWW::OpenAPIClient::Object::CostingLine;
...
__PACKAGE__->class_documentation({description => 'A single costing line: material cost for one BOM component.',
                                  class => 'CostingLine',
                                  required => [], # TODO
}                                 );
