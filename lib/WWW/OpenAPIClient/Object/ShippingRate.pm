...
#
package WWW::OpenAPIClient::Object::ShippingRate;
...
__PACKAGE__->method_documentation({
    ...
    'cross_border_surcharge' => {
        datatype => 'string',
        base_name => 'cross_border_surcharge',
        description => '',
        format => '',
        read_only => '',
            },
