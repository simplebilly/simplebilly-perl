...
#
package WWW::OpenAPIClient::Object::InstituteProfileUpdate;
...
__PACKAGE__->class_documentation({description => 'Partial update of the institute profile.',
