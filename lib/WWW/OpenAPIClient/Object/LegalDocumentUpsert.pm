...
#
package WWW::OpenAPIClient::Object::LegalDocumentUpsert;
...
__PACKAGE__->class_documentation({description => 'One document to upsert (&#x60;PUT /api/v1/legal/documents&#x60; body element).',
