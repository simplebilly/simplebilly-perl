...
#
package WWW::OpenAPIClient::Object::GenerateCountRequest;
...
__PACKAGE__->class_documentation({description => 'Body for the cycle-count generator: create a draft count document for a warehouse, optionally restricted to a set of product ids.',
