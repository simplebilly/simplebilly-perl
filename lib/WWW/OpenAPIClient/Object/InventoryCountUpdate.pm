...
#
package WWW::OpenAPIClient::Object::InventoryCountUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'line_items' => {
        datatype => 'object',
        base_name => 'lineItems',
        description => 'JSON array of &#x60;{product_id, name, sku, expected_quantity, counted_quantity, bin_location?, batch_number?, variance}&#x60;.',
        format => '',
        read_only => '',
            },
    'notes' => {
