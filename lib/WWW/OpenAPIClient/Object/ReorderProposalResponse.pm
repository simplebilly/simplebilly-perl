...
#
package WWW::OpenAPIClient::Object::ReorderProposalResponse;
...
__PACKAGE__->class_documentation({description => 'The response envelope for a reorder proposal run.',
...
__PACKAGE__->method_documentation({
    ...
    'lines' => {
        datatype => 'ARRAY[ReorderProposalLine]',
        base_name => 'lines',
        description => '',
        format => '',
        read_only => '',
    ...
    'total_suggested_quantity' => {
        datatype => 'int',
        base_name => 'totalSuggestedQuantity',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'lines' => 'ARRAY[ReorderProposalLine]',
