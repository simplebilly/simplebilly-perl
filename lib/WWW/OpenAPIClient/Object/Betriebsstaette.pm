...
#
package WWW::OpenAPIClient::Object::Betriebsstaette;
...
__PACKAGE__->class_documentation({description => 'Eine Betriebsstätte mit der Anzahl der sozialversicherungspflichtig Beschäftigten (Jahresdurchschnitt des Vorjahres).',
