...
#
package WWW::OpenAPIClient::Object::AnlageGErgebnis;
...
__PACKAGE__->method_documentation({
    ...
    'gewst_messbetrag_approx' => {
        datatype => 'string',
        base_name => 'gewst_messbetrag_approx',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'kfz_hinweise' => {
        datatype => 'ARRAY[AnlageGKfzHinweis]',
        base_name => 'kfz_hinweise',
        description => '',
        format => '',
        read_only => '',
            },
