...
#
package WWW::OpenAPIClient::Object::ContactHistoryResponse;
...
__PACKAGE__->class_documentation({description => 'Aggregated history for a single contact: all communications plus a lightweight per-channel breakdown.',
...
__PACKAGE__->method_documentation({
    ...
    'inbound_count' => {
        datatype => 'int',
        base_name => 'inboundCount',
        description => '',
        format => '',
        read_only => '',
            },
    'items' => {
        datatype => 'ARRAY[CustomerCommunication]',
        base_name => 'items',
        description => '',
        format => '',
        read_only => '',
