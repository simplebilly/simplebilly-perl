...
#
package WWW::OpenAPIClient::Object::SubmitResultDto;
...
__PACKAGE__->method_documentation({
    ...
    'score' => {
        datatype => 'int',
        base_name => 'score',
        description => 'Score 0–100. Only trusted for plugin trainings without server-side scoring; builtin trainings are always re-scored from &#x60;answers&#x60;.',
        format => '',
        read_only => '',
            },
    'training_code' => {
        datatype => 'string',
        base_name => 'trainingCode',
        description => '',
        format => '',
        read_only => '',
            },
