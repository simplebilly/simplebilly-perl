...
#
package WWW::OpenAPIClient::Object::LegalDocumentReset;
...
__PACKAGE__->class_documentation({description => 'Optional filter for &#x60;POST /api/v1/legal/documents/reset&#x60;; empty body restores every document of the tenant.',
