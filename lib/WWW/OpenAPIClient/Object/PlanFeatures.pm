...
#
package WWW::OpenAPIClient::Object::PlanFeatures;
...
__PACKAGE__->class_documentation({description => 'Feature flags per plan.',
                                  class => 'PlanFeatures',
                                  required => [], # TODO
}                                 );
