...
#
package WWW::OpenAPIClient::Object::ActivityCreate;
...
__PACKAGE__->method_documentation({
    ...
    'contact_id' => {
        datatype => 'string',
        base_name => 'contactId',
        description => 'Contact this activity belongs to (&#x60;contact.contact_id&#x60;). References the contact entity.',
        format => '',
        read_only => '',
            },
    'description' => {
    ...
    'due_date' => {
        datatype => 'DATE',
        base_name => 'dueDate',
        description => 'Follow-up / Wiedervorlage date. Open activities with a due date in the past are overdue.',
        format => '',
        read_only => '',
            },
    'reminder_date' => {
        datatype => 'DATE',
        base_name => 'reminderDate',
        description => 'When to remind about the follow-up.',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'ActivityStatus',
        base_name => 'status',
