...
#
package WWW::OpenAPIClient::Object::CustomerInfo;
...
__PACKAGE__->class_documentation({description => 'Additional information about the customer placing the shipment.',
                                  class => 'CustomerInfo',
                                  required => [], # TODO
}                                 );
