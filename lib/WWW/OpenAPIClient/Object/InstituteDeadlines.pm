...
#
package WWW::OpenAPIClient::Object::InstituteDeadlines;
...
__PACKAGE__->method_documentation({
    'abschlusspruefung_months' => {
        datatype => 'int',
        base_name => 'abschlusspruefungMonths',
        description => 'HGB § 340k/§ 341k: Abschlussprüfung (5 Monate).',
        format => '',
        read_only => '',
            },
    'jahresabschluss_bafin_months' => {
        datatype => 'int',
        base_name => 'jahresabschlussBafinMonths',
...
__PACKAGE__->openapi_types( {
    'abschlusspruefung_months' => 'int',
    'jahresabschluss_bafin_months' => 'int',
    'offenlegung_months' => 'int'
} );

__PACKAGE__->attribute_map( {
    'abschlusspruefung_months' => 'abschlusspruefungMonths',
    'jahresabschluss_bafin_months' => 'jahresabschlussBafinMonths',
    'offenlegung_months' => 'offenlegungMonths'
} );
