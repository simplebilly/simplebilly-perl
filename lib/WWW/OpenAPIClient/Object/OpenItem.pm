...
#
package WWW::OpenAPIClient::Object::OpenItem;
...
__PACKAGE__->method_documentation({
    ...
    'open_amount' => {
        datatype => 'string',
        base_name => 'open_amount',
        description => '',
        format => '',
        read_only => '',
            },
    'reminder_level' => {
        datatype => 'ReminderLevel',
        base_name => 'reminder_level',
        description => '',
        format => '',
        read_only => '',
            },
