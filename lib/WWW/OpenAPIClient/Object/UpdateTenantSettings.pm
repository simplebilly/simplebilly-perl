...
#
package WWW::OpenAPIClient::Object::UpdateTenantSettings;
...
__PACKAGE__->class_documentation({description => 'Request payload for updating tenant settings.',
...
__PACKAGE__->method_documentation({
    'company_type' => {
        datatype => 'CompanyType',
        base_name => 'companyType',
        description => '',
        format => '',
        read_only => '',
            },
    'features' => {
        datatype => 'PartialFeatureSettings',
        base_name => 'features',
        description => '',
        format => '',
        read_only => '',
