...
#
package WWW::OpenAPIClient::Object::ShippingThresholdCreate;
...
__PACKAGE__->method_documentation({
    ...
    'product_id' => {
        datatype => 'string',
        base_name => 'productId',
        description => 'None &#x3D; applies to all products. References the product entity.',
        format => '',
        read_only => '',
            },
    'reserve_stock' => {
        datatype => 'int',
        base_name => 'reserveStock',
    ...
    'warehouse_id' => {
        ...
        description => 'None &#x3D; applies to all warehouses. References the warehouse entity.',
        format => '',
        read_only => '',
            },
});
