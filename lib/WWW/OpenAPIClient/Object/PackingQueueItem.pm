...
#
package WWW::OpenAPIClient::Object::PackingQueueItem;
...
__PACKAGE__->method_documentation({
    ...
    'delivery_note_printed' => {
        datatype => 'boolean',
        base_name => 'delivery_note_printed',
        description => '',
        format => '',
        read_only => '',
            },
