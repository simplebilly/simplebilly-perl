...
#
package WWW::OpenAPIClient::Object::KonzernStatus;
...
__PACKAGE__->method_documentation({
    ...
    'kapitalmarktorientiert' => {
        datatype => 'boolean',
        base_name => 'kapitalmarktorientiert',
        description => '',
        format => '',
        read_only => '',
            },
    'konzernabschlusspflicht' => {
        datatype => 'boolean',
        base_name => 'konzernabschlusspflicht',
        description => '',
        format => '',
        read_only => '',
            },
    'missing_group_figures' => {
        datatype => 'boolean',
        base_name => 'missing_group_figures',
    ...
    'parent_situs' => {
        datatype => 'string',
        base_name => 'parent_situs',
        description => '',
        format => '',
        read_only => '',
            },
    'participations' => {
        datatype => 'ARRAY[KonzernBeteiligung]',
        base_name => 'participations',
        description => '',
        format => '',
        read_only => '',
            },
    'thresholds' => {
        datatype => 'KonzernThresholds',
        base_name => 'thresholds',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'zwischenholding_befreit' => {
        datatype => 'boolean',
        base_name => 'zwischenholding_befreit',
        description => '',
        format => '',
        read_only => '',
            },
    'zwischenholding_hinweis' => {
        datatype => 'string',
        base_name => 'zwischenholding_hinweis',
