...
#
package WWW::OpenAPIClient::Object::ConvertResponse;
...
__PACKAGE__->class_documentation({description => 'Response of the proforma → invoice conversion.',
