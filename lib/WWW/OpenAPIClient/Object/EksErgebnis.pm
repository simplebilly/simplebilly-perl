...
#
package WWW::OpenAPIClient::Object::EksErgebnis;
...
__PACKAGE__->method_documentation({
    'gesamtergebnis' => {
        datatype => 'string',
        base_name => 'gesamtergebnis',
        description => '',
        format => '',
        read_only => '',
            },
    'monate' => {
        datatype => 'ARRAY[EksMonatsWert]',
        base_name => 'monate',
        description => '',
        format => '',
        read_only => '',
    ...
    'prognose_naechste_6_monate' => {
        datatype => 'string',
        base_name => 'prognose_naechste_6_monate',
        description => '',
        format => '',
        read_only => '',
            },
