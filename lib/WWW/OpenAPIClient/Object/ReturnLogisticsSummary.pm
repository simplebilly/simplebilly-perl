...
#
package WWW::OpenAPIClient::Object::ReturnLogisticsSummary;
...
__PACKAGE__->class_documentation({description => 'Warehouse-level aggregation for the returns logistics dashboard.',
...
__PACKAGE__->method_documentation({
    ...
    'by_warehouse' => {
        datatype => 'ARRAY[ReturnWarehouseSummary]',
        base_name => 'byWarehouse',
