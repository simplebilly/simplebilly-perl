...
#
package WWW::OpenAPIClient::Object::ProformaInvoiceUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'converted_to_invoice_id' => {
        datatype => 'string',
        base_name => 'convertedToInvoiceId',
        description => 'Set when the proforma was converted into a real invoice. References the invoice entity.',
        format => '',
        read_only => '',
            },
    'currency' => {
    ...
    'quotation_id' => {
        datatype => 'string',
        base_name => 'quotationId',
        description => 'References the quotation entity.',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'ProformaInvoiceStatus',
        base_name => 'status',
