...
__PACKAGE__->method_documentation({
    ...
    'password_changed_at' => {
        datatype => 'DATE_TIME',
        base_name => 'password_changed_at',
        description => 'Set on password change; auth/refresh tokens issued before this timestamp are rejected by the auth middleware.',
        format => '',
        read_only => '',
            },
    'password_hash' => {
...
__PACKAGE__->openapi_types( {
    ...
    'password_changed_at' => 'DATE_TIME',
    'password_hash' => 'string',
    'picture' => 'string',
    'privacy_accepted_at' => 'DATE_TIME',
    'totp_secret' => 'string',
