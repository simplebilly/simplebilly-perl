...
#
package WWW::OpenAPIClient::Object::PlanLimits;
...
__PACKAGE__->class_documentation({description => 'Per-plan numeric limits. &#x60;-1&#x60; in any field means unlimited.',
                                  class => 'PlanLimits',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'paid_connectors' => {
        ...
        base_name => 'paidConnectors',
        description => 'Connectors that are *not* included in this plan (require a higher tier). Empty &#x3D; all connectors included on this plan.',
        format => '',
        read_only => '',
            },
});
