...
#
package WWW::OpenAPIClient::Object::RecurringTemplateUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'execution_interval' => {
        datatype => 'string',
        base_name => 'executionInterval',
        description => '',
        format => '',
        read_only => '',
            },
    'execution_status' => {
        datatype => 'ExecutionStatus',
        base_name => 'executionStatus',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'template_type' => {
        datatype => 'RecurringTemplateType',
...
__PACKAGE__->openapi_types( {
    ...
    'finalize' => 'boolean',
    'last_executed_at' => 'DATE_TIME',
    'name' => 'string',
    'next_execution_at' => 'DATE_TIME',
    'start_date' => 'DATE',
