...
#
package WWW::OpenAPIClient::Object::GewinnverwendungsReport;
...
__PACKAGE__->method_documentation({
    ...
    'gesetzliche_ruecklage_bestand' => {
        datatype => 'string',
        base_name => 'gesetzliche_ruecklage_bestand',
        description => '',
        format => '',
        read_only => '',
            },
    'gesetzliche_ruecklage_cap' => {
        datatype => 'string',
        base_name => 'gesetzliche_ruecklage_cap',
    ...
    'gesetzliche_ruecklage_nach' => {
        datatype => 'string',
        base_name => 'gesetzliche_ruecklage_nach',
    ...
    'gesetzliche_ruecklage_soll' => {
        datatype => 'string',
        base_name => 'gesetzliche_ruecklage_soll',
    ...
    'gezeichnetes_kapital' => {
        datatype => 'string',
        base_name => 'gezeichnetes_kapital',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'zeilen' => {
        datatype => 'ARRAY[GewinnverwendungsZeile]',
        base_name => 'zeilen',
        description => '',
        format => '',
        read_only => '',
