...
#
package WWW::OpenAPIClient::Object::GenerateVariantsRequest;
...
__PACKAGE__->class_documentation({description => 'Request body for generating the full variant set from option values.',
...
__PACKAGE__->method_documentation({
    'options' => {
        ...
        base_name => 'options',
        description => 'Option name → list of values, e.g. &#x60;{\&quot;Color\&quot;: [\&quot;Red\&quot;, \&quot;Blue\&quot;], \&quot;Size\&quot;: [\&quot;S\&quot;, \&quot;M\&quot;]}&#x60;. The cartesian product of these lists is generated.',
        format => '',
        read_only => '',
            },
    'price_delta' => {
        datatype => 'string',
        base_name => 'priceDelta',
    ...
    'sku_prefix' => {
        datatype => 'string',
        base_name => 'skuPrefix',
        description => 'Optional prefix for the generated SKUs (suffix is the option values joined by &#x60;-&#x60;). Falls back to the parent product&#39;s SKU.',
        format => '',
        read_only => '',
            },
});
