...
#
package WWW::OpenAPIClient::Object::BWASummary;
...
__PACKAGE__->method_documentation({
    ...
    'overdue_invoices_count' => {
        datatype => 'int',
        base_name => 'overdue_invoices_count',
        description => '',
        format => '',
        read_only => '',
            },
    'overdue_invoices_total' => {
        datatype => 'string',
        base_name => 'overdue_invoices_total',
        description => '',
        format => '',
        read_only => '',
            },
