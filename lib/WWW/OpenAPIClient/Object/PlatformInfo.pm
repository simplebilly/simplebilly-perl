...
#
package WWW::OpenAPIClient::Object::PlatformInfo;
...
__PACKAGE__->class_documentation({description => 'Public metadata for one registered plugin (admin UI). Maps 1:1 from [&#x60;plugin_core::PluginInfo&#x60;] (same field shape as before).',
                                  class => 'PlatformInfo',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'config_field_names' => {
        ...
        base_name => 'config_field_names',
        description => '',
        format => '',
        read_only => '',
            },
    'config_fields' => {
        datatype => 'ARRAY[ConfigFieldInfo]',
        base_name => 'config_fields',
        description => '',
        format => '',
        read_only => '',
            },
