...
#
package WWW::OpenAPIClient::Object::YearlyPayrollSummary;
...
__PACKAGE__->method_documentation({
    'avg_employee_count' => {
        datatype => 'int',
        base_name => 'avg_employee_count',
        description => '',
        format => '',
        read_only => '',
            },
    'months' => {
        datatype => 'ARRAY[PayrollSummaryItem]',
        base_name => 'months',
        description => '',
        format => '',
        read_only => '',
    ...
    'yearly_employer_cost' => {
        datatype => 'string',
        base_name => 'yearly_employer_cost',
        description => '',
        format => '',
        read_only => '',
            },
