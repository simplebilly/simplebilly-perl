...
#
package WWW::OpenAPIClient::Object::ConnectorType;
...
__PACKAGE__->class_documentation({description => 'How a marketplace connector authenticates: static API key or OAuth2.',
                                  class => 'ConnectorType',
                                  required => [], # TODO
}                                 );
