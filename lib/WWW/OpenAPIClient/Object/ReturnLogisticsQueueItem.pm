...
#
package WWW::OpenAPIClient::Object::ReturnLogisticsQueueItem;
...
__PACKAGE__->class_documentation({description => 'One open return awaiting warehouse processing (inbound queue).',
