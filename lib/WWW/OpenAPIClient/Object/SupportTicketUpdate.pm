...
#
package WWW::OpenAPIClient::Object::SupportTicketUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'channel_type' => {
        datatype => 'SupportChannelType',
        base_name => 'channelType',
        description => '',
        format => '',
        read_only => '',
            },
