...
#
package WWW::OpenAPIClient::Object::CustomerCommunicationCreate;
...
__PACKAGE__->method_documentation({
    ...
    'contact_id' => {
        datatype => 'string',
        base_name => 'contactId',
        description => 'The contact (customer/supplier) this communication belongs to. References the contact entity.',
        format => '',
        read_only => '',
            },
    'counterparty' => {
        datatype => 'string',
        base_name => 'counterparty',
        description => 'Email/phone of the counterparty, if applicable.',
        format => '',
        read_only => '',
            },
    'direction' => {
        datatype => 'CommunicationDirection',
        base_name => 'direction',
        description => '',
        format => '',
        read_only => '',
