...
#
package WWW::OpenAPIClient::Object::ShippingCredentials;
...
__PACKAGE__->class_documentation({description => 'Per-tenant credentials for real shipping provider APIs (stored in the &#x60;shipping&#x60; key of the settings JSON blob). Auth is either OAuth client credentials (UPS) or a user-supplied API key (DHL).',
