...
#
package WWW::OpenAPIClient::Object::AttachmentCreate;
...
__PACKAGE__->method_documentation({
    'contact_id' => {
        datatype => 'string',
        base_name => 'contactId',
        description => 'Contact this attachment belongs to (per-contact DMS). References the contact entity.',
        format => '',
        read_only => '',
            },
    'file_name' => {
