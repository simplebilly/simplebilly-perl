...
#
package WWW::OpenAPIClient::Object::PrecedingSalesVoucherType;
...
__PACKAGE__->class_documentation({description => 'Type of the sales voucher that preceded this document.',
