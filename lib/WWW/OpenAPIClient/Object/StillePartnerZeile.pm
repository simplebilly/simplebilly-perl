...
#
package WWW::OpenAPIClient::Object::StillePartnerZeile;
...
__PACKAGE__->method_documentation({
    'auseinandersetzungsguthaben' => {
        datatype => 'string',
        base_name => 'auseinandersetzungsguthaben',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'verlust_verrechnungskonto' => {
        datatype => 'string',
        base_name => 'verlust_verrechnungskonto',
        description => '',
        format => '',
        read_only => '',
            },
