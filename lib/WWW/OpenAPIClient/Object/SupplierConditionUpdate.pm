...
#
package WWW::OpenAPIClient::Object::SupplierConditionUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'early_payment_discount_percent' => {
        datatype => 'string',
        base_name => 'earlyPaymentDiscountPercent',
    ...
    'supplier_contact_id' => {
        ...
        description => 'The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity.',
        format => '',
        read_only => '',
            },
    'supplier_name' => {
