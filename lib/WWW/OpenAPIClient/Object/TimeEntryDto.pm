...
#
package WWW::OpenAPIClient::Object::TimeEntryDto;
...
__PACKAGE__->class_documentation({description => 'API shape returned to the frontend (matches &#x60;frontend/src/types/time-entry.ts&#x60;).',
                                  class => 'TimeEntryDto',
                                  required => [], # TODO
}                                 );
