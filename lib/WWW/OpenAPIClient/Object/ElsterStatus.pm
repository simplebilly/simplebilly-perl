...
#
package WWW::OpenAPIClient::Object::ElsterStatus;
...
__PACKAGE__->method_documentation({
    ...
    'vendor_id_configured' => {
        datatype => 'boolean',
        base_name => 'vendor_id_configured',
        description => '',
        format => '',
        read_only => '',
            },
