...
#
package WWW::OpenAPIClient::Object::SuitabilityResult;
...
__PACKAGE__->method_documentation({
    'methods' => {
        datatype => 'ARRAY[MethodSuitability]',
        base_name => 'methods',
        description => '',
        format => '',
        read_only => '',
