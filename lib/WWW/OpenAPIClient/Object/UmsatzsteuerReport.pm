...
#
package WWW::OpenAPIClient::Object::UmsatzsteuerReport;
...
__PACKAGE__->method_documentation({
    'generated_at' => {
        datatype => 'string',
        base_name => 'generated_at',
        description => '',
        format => '',
        read_only => '',
            },
    'input_tax' => {
        datatype => 'ARRAY[VatDetail]',
        base_name => 'input_tax',
        description => '',
        format => '',
        read_only => '',
