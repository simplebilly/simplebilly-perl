...
#
package WWW::OpenAPIClient::Object::PayrollRunApi;
...
__PACKAGE__->method_documentation({
    ...
    'entries' => {
        datatype => 'ARRAY[PayrollEntryApi]',
        base_name => 'entries',
        description => '',
        format => '',
        read_only => '',
    ...
    'total_employee_count' => {
        datatype => 'int',
        base_name => 'total_employee_count',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'total_social_security' => {
        datatype => 'string',
        base_name => 'total_social_security',
        description => '',
        format => '',
        read_only => '',
            },
