...
#
package WWW::OpenAPIClient::Object::DpaStatus;
...
__PACKAGE__->class_documentation({description => 'DPA acceptance status of the tenant.',
                                  class => 'DpaStatus',
                                  required => [], # TODO
}                                 );
