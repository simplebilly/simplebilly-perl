...
#
package WWW::OpenAPIClient::Object::TimelineEvent;
...
__PACKAGE__->class_documentation({description => 'Single timeline entry aggregated from the contact&#39;s activity across all related modules (communications, quotations, orders, invoices, documents).',
                                  class => 'TimelineEvent',
                                  required => [], # TODO
}                                 );
