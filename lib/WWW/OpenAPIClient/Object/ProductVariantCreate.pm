...
#
package WWW::OpenAPIClient::Object::ProductVariantCreate;
...
__PACKAGE__->method_documentation({
    ...
    'price' => {
        datatype => 'string',
        base_name => 'price',
        description => 'Explicit override price for this variant (takes precedence over parent price + delta).',
        format => '',
        read_only => '',
            },
    'price_delta' => {
    ...
    'product_id' => {
        datatype => 'string',
        base_name => 'productId',
        description => 'The parent product this variant belongs to. References the product entity.',
        format => '',
        read_only => '',
            },
    'sku' => {
