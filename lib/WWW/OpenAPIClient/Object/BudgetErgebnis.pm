...
#
package WWW::OpenAPIClient::Object::BudgetErgebnis;
...
__PACKAGE__->method_documentation({
    ...
    'monats_budget' => {
        datatype => 'ARRAY[BudgetKategorie]',
        base_name => 'monats_budget',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'jahr' => 'int',
    'monat' => 'int',
    'monats_budget' => 'ARRAY[BudgetKategorie]',
    'prognose_restjahr' => 'ARRAY[BudgetKategorie]'
} );
