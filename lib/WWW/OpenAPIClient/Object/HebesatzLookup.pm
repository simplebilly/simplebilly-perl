...
#
package WWW::OpenAPIClient::Object::HebesatzLookup;
...
__PACKAGE__->method_documentation({
    ...
    'hebesatz_gewerbesteuer' => {
        datatype => 'double',
        base_name => 'hebesatz_gewerbesteuer',
        description => '',
        format => '',
        read_only => '',
            },
    'hebesatz_grundsteuer_b' => {
        datatype => 'double',
        base_name => 'hebesatz_grundsteuer_b',
        description => '',
        format => '',
        read_only => '',
            },
