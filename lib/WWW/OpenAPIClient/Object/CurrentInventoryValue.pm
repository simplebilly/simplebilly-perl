...
#
package WWW::OpenAPIClient::Object::CurrentInventoryValue;
...
__PACKAGE__->method_documentation({
    'history' => {
        datatype => 'ARRAY[InventoryValuePoint]',
        base_name => 'history',
        description => '',
        format => '',
        read_only => '',
    ...
    'total_purchase_value' => {
        datatype => 'string',
        base_name => 'total_purchase_value',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'history' => 'ARRAY[InventoryValuePoint]',
    'product_count' => 'int',
