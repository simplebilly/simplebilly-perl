...
#
package WWW::OpenAPIClient::Object::ProductAttributeCreate;
...
__PACKAGE__->method_documentation({
    ...
    'product_id' => {
        datatype => 'string',
        base_name => 'productId',
        description => 'The product this attribute belongs to. References the product entity.',
        format => '',
        read_only => '',
            },
    'unit' => {
