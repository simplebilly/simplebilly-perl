...
#
package WWW::OpenAPIClient::Object::ImportJobStatus;
...
__PACKAGE__->method_documentation({
    ...
    'provider' => {
        datatype => 'string',
        base_name => 'provider',
        description => 'Which competitor the import came from (lexoffice | billbee); the frontend uses it to label the job. Absent for legacy jobs.',
        format => '',
        read_only => '',
            },
    'stage' => {
