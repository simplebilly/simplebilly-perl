...
#
package WWW::OpenAPIClient::Object::WebhookEventStatus;
...
__PACKAGE__->class_documentation({description => 'Webhook event delivery status: accepted | delivered | failed.',
