...
#
package WWW::OpenAPIClient::Object::DpaAcceptRequest;
...
__PACKAGE__->class_documentation({description => 'Request body to record DPA acceptance (&#x60;PUT /api/v1/gdpr/dpa&#x60;).',
