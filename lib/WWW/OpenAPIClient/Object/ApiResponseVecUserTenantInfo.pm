...
#
package WWW::OpenAPIClient::Object::ApiResponseVecUserTenantInfo;
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'ARRAY[ApiResponseVecUserTenantInfoDataInner]',
        base_name => 'data',
        description => '',
        format => '',
        read_only => '',
...
__PACKAGE__->openapi_types( {
    'data' => 'ARRAY[ApiResponseVecUserTenantInfoDataInner]',
    'error' => 'string',
    'message' => 'string',
    'success' => 'boolean'
} );
