...
#
package WWW::OpenAPIClient::Object::TaxRateCreate;
...
__PACKAGE__->method_documentation({
    ...
    'is_default' => {
        datatype => 'boolean',
        base_name => 'isDefault',
        description => 'Default rate for the country (one per country); fallback for lookups when no dated rate applies.',
        format => '',
        read_only => '',
            },
    'name' => {
