...
#
package WWW::OpenAPIClient::Object::TrackOrderRequest;
...
__PACKAGE__->class_documentation({description => 'Refresh tracking for a shipment from the live carrier API and store the latest status + events on the shipment row.',
