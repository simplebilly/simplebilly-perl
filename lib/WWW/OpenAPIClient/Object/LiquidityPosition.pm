...
#
package WWW::OpenAPIClient::Object::LiquidityPosition;
...
__PACKAGE__->method_documentation({
    ...
    'cash_and_equivalents' => {
        datatype => 'double',
        base_name => 'cash_and_equivalents',
        description => '',
        format => '',
        read_only => '',
            },
