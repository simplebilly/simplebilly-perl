...
#
package WWW::OpenAPIClient::Object::QuotaOverride;
...
__PACKAGE__->class_documentation({description => 'Schema of the &#x60;tenants.quotas&#x60; JSON override column. Any field that is present overrides the plan-derived value.',
                                  class => 'QuotaOverride',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'features' => {
        datatype => 'QuotaOverrideFeatures',
        base_name => 'features',
        description => '',
        format => '',
        read_only => '',
    ...
    'max_invoices_per_month' => {
        datatype => 'int',
        base_name => 'max_invoices_per_month',
        description => '',
        format => '',
        read_only => '',
            },
