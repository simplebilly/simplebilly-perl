...
#
package WWW::OpenAPIClient::Object::ApiResponseGdprExportData;
...
__PACKAGE__->method_documentation({
    'activity_log' => {
        datatype => 'ARRAY[GdprActivity]',
        base_name => 'activityLog',
        description => '',
        format => '',
        read_only => '',
            },
    'api_keys' => {
        datatype => 'ARRAY[GdprApiKey]',
        base_name => 'apiKeys',
    ...
    'billing' => {
        datatype => 'ARRAY[GdprBillingInfo]',
        base_name => 'billing',
        description => '',
        format => '',
        read_only => '',
    ...
    'refresh_tokens' => {
        datatype => 'ARRAY[GdprRefreshToken]',
        base_name => 'refreshTokens',
        description => 'Session records: metadata only, never the token hash.',
        format => '',
        read_only => '',
            },
    'tenants' => {
        datatype => 'ARRAY[GdprTenant]',
        base_name => 'tenants',
        description => '',
        format => '',
        read_only => '',
    ...
    'usage_events' => {
        datatype => 'ARRAY[GdprUsageEvent]',
        base_name => 'usageEvents',
        description => '',
        format => '',
        read_only => '',
            },
