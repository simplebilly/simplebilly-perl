...
#
package WWW::OpenAPIClient::Object::DeliveryDateCreate;
...
__PACKAGE__->method_documentation({
    ...
    'product_id' => {
        datatype => 'string',
        base_name => 'productId',
        description => 'Product line item this date applies to, if per-item. References the product entity.',
        format => '',
        read_only => '',
            },
    'promised_date' => {
        datatype => 'DATE',
        base_name => 'promisedDate',
        description => 'Date promised to the customer.',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'DeliveryDateStatus',
        base_name => 'status',
