...
#
package WWW::OpenAPIClient::Object::ProductionOrderCosting;
...
__PACKAGE__->class_documentation({description => 'Actual-costing (Nachkalkulation) report for a production order.',
