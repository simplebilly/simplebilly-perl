...
#
package WWW::OpenAPIClient::Object::ReturnOrder;
...
__PACKAGE__->method_documentation({
    ...
    'return_reason' => {
        datatype => 'string',
        base_name => 'returnReason',
        description => '',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'ReturnOrderStatus',
        base_name => 'status',
    ...
    'warehouse_id' => {
        ...
        description => 'Warehouse into which restockable items are returned. References the warehouse entity.',
        format => '',
        read_only => '',
            },
});
