...
#
package WWW::OpenAPIClient::Object::UsageSnapshot;
...
__PACKAGE__->class_documentation({description => 'Current usage for a tenant. &#x60;overage_seats&#x60; is what billing charges 5€/seat/month on.',
                                  class => 'UsageSnapshot',
                                  required => [], # TODO
}                                 );
