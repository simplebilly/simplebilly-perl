...
#
package WWW::OpenAPIClient::Object::NewVersionRequest;
...
__PACKAGE__->class_documentation({description => 'Body for uploading a new version. Bytes must already be stored under &#x60;file_name&#x60; via the object storage API.',
