...
#
package WWW::OpenAPIClient::Object::JahresUstErgebnis;
...
__PACKAGE__->method_documentation({
    ...
    'gespeicherte_perioden' => {
        datatype => 'int',
        base_name => 'gespeicherte_perioden',
        description => '',
        format => '',
        read_only => '',
            },
    'hat_ig_transaktionen' => {
        datatype => 'boolean',
        base_name => 'hat_ig_transaktionen',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'summe_vorauszahlungen' => {
        datatype => 'string',
        base_name => 'summe_vorauszahlungen',
        description => '',
        format => '',
        read_only => '',
            },
