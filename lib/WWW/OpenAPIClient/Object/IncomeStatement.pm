...
#
package WWW::OpenAPIClient::Object::IncomeStatement;
...
__PACKAGE__->method_documentation({
    'expense_items' => {
        datatype => 'ARRAY[PnLItem]',
        base_name => 'expense_items',
        description => '',
        format => '',
        read_only => '',
            },
