...
#
package WWW::OpenAPIClient::Object::PublicPosting;
...
__PACKAGE__->class_documentation({description => 'Minimal shape for the public careers page (no tenant internals).',
                                  class => 'PublicPosting',
                                  required => [], # TODO
}                                 );
