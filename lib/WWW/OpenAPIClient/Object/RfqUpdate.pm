...
#
package WWW::OpenAPIClient::Object::RfqUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'line_items' => {
        datatype => 'object',
        base_name => 'lineItems',
        description => 'JSON array of &#x60;{product_id, name, sku, quantity, requested_unit_price?, quoted_unit_price?}&#x60;.',
        format => '',
        read_only => '',
            },
    'notes' => {
