...
#
package WWW::OpenAPIClient::Object::ProviderInfo;
...
__PACKAGE__->method_documentation({
    ...
    'supports_label_creation' => {
        datatype => 'boolean',
        base_name => 'supports_label_creation',
        description => '',
        format => '',
        read_only => '',
            },
    'supports_rate_estimation' => {
        datatype => 'boolean',
        base_name => 'supports_rate_estimation',
        description => '',
        format => '',
        read_only => '',
            },
