...
#
package WWW::OpenAPIClient::Object::ReplenishmentSuggestionLine;
...
__PACKAGE__->class_documentation({description => 'A single replenishment suggestion.',
