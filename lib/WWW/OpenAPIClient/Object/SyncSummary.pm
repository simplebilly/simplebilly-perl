...
#
package WWW::OpenAPIClient::Object::SyncSummary;
...
__PACKAGE__->class_documentation({description => 'Result of a sync/export run — what the app reports back to the admin UI.',
                                  class => 'SyncSummary',
                                  required => [], # TODO
}                                 );
