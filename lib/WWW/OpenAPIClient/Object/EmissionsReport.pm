...
#
package WWW::OpenAPIClient::Object::EmissionsReport;
...
__PACKAGE__->method_documentation({
    'by_category' => {
        datatype => 'ARRAY[CategoryTotal]',
        base_name => 'by_category',
        description => '',
        format => '',
        read_only => '',
            },
    'by_scope' => {
        datatype => 'ARRAY[ScopeTotal]',
        base_name => 'by_scope',
        description => '',
        format => '',
        read_only => '',
    ...
    'intensity_per_employee' => {
        datatype => 'double',
        base_name => 'intensity_per_employee',
        description => '',
        format => '',
        read_only => '',
            },
    'intensity_per_revenue_mio' => {
        datatype => 'double',
        base_name => 'intensity_per_revenue_mio',
