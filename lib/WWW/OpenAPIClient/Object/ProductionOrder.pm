...
#
package WWW::OpenAPIClient::Object::ProductionOrder;
...
__PACKAGE__->method_documentation({
    ...
    'product_id' => {
        datatype => 'string',
        base_name => 'productId',
        description => 'The finished product to manufacture. References the product entity.',
        format => '',
        read_only => '',
            },
    'quantity' => {
    ...
    'source_warehouse_id' => {
        datatype => 'string',
        base_name => 'sourceWarehouseId',
        description => 'Warehouse components are consumed from. References the warehouse entity.',
        format => '',
        read_only => '',
            },
    'start_date' => {
    ...
    'status' => {
        datatype => 'ProductionOrderStatus',
        base_name => 'status',
    ...
    'target_warehouse_id' => {
        datatype => 'string',
        base_name => 'targetWarehouseId',
        description => 'Warehouse the finished product is added to. References the warehouse entity.',
        format => '',
        read_only => '',
            },
});
