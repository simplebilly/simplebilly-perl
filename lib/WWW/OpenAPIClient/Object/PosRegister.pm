...
#
package WWW::OpenAPIClient::Object::PosRegister;
...
__PACKAGE__->class_documentation({description => 'A point-of-sale register (Kasse). Registers are the billable unit of the POS feature: each active register costs a monthly fee per tenant, billed through Paddle. &#x60;status&#x60;: &#x60;active&#x60; | &#x60;disabled&#x60;.',
                                  class => 'PosRegister',
                                  required => [], # TODO
}                                 );
