...
#
package WWW::OpenAPIClient::Object::CommunicationDirection;
...
__PACKAGE__->class_documentation({description => 'Direction of the communication relative to the business.',
