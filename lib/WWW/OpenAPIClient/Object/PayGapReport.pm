...
#
package WWW::OpenAPIClient::Object::PayGapReport;
...
__PACKAGE__->method_documentation({
    'by_job_title' => {
        datatype => 'ARRAY[JobTitleGap]',
        base_name => 'by_job_title',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'median_gap_pct' => {
        datatype => 'double',
        base_name => 'median_gap_pct',
        description => '',
        format => '',
        read_only => '',
            },
    'quartiles' => {
        datatype => 'ARRAY[QuartileBand]',
        base_name => 'quartiles',
        description => '',
        format => '',
        read_only => '',
