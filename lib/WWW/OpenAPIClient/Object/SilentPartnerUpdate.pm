...
#
package WWW::OpenAPIClient::Object::SilentPartnerUpdate;
...
__PACKAGE__->method_documentation({
    ...
    'verlust_verrechnungskonto' => {
        datatype => 'string',
        base_name => 'verlustVerrechnungskonto',
