...
use_ok('WWW::OpenAPIClient::KstApi');

my $api = WWW::OpenAPIClient::KstApi->new();
isa_ok($api, 'WWW::OpenAPIClient::KstApi');

#
# kst_api test
#
# uncomment below and update the test
#my $kst_api_year = undef; # replace NULL with a proper value
#my $kst_api_gewinn = undef; # replace NULL with a proper value
#my $kst_api_result = $api->kst_api(year => $kst_api_year, gewinn => $kst_api_gewinn);
