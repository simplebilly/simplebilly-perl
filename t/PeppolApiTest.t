...
use_ok('WWW::OpenAPIClient::PeppolApi');

my $api = WWW::OpenAPIClient::PeppolApi->new();
isa_ok($api, 'WWW::OpenAPIClient::PeppolApi');

#
# peppol_api test
#
# uncomment below and update the test
#my $peppol_api_id = undef; # replace NULL with a proper value
#my $peppol_api_result = $api->peppol_api(id => $peppol_api_id);
