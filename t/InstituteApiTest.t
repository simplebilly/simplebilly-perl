...
use_ok('WWW::OpenAPIClient::InstituteApi');

my $api = WWW::OpenAPIClient::InstituteApi->new();
isa_ok($api, 'WWW::OpenAPIClient::InstituteApi');

#
# institute_status_api test
#
# uncomment below and update the test
#my $institute_status_api_result = $api->institute_status_api();
