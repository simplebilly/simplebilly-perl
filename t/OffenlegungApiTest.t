...
use_ok('WWW::OpenAPIClient::OffenlegungApi');

my $api = WWW::OpenAPIClient::OffenlegungApi->new();
isa_ok($api, 'WWW::OpenAPIClient::OffenlegungApi');

#
# offenlegung_api test
#
# uncomment below and update the test
#my $offenlegung_api_result = $api->offenlegung_api();
