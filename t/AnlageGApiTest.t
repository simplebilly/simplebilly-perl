...
use_ok('WWW::OpenAPIClient::AnlageGApi');

my $api = WWW::OpenAPIClient::AnlageGApi->new();
isa_ok($api, 'WWW::OpenAPIClient::AnlageGApi');

#
# anlage_g_api test
#
# uncomment below and update the test
#my $anlage_g_api_year = undef; # replace NULL with a proper value
#my $anlage_g_api_result = $api->anlage_g_api(year => $anlage_g_api_year);
