...
use_ok('WWW::OpenAPIClient::OssReportApi');

my $api = WWW::OpenAPIClient::OssReportApi->new();
isa_ok($api, 'WWW::OpenAPIClient::OssReportApi');

#
# oss_report_api test
#
# uncomment below and update the test
#my $oss_report_api_result = $api->oss_report_api();
