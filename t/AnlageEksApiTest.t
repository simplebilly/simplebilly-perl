...
use_ok('WWW::OpenAPIClient::AnlageEksApi');

my $api = WWW::OpenAPIClient::AnlageEksApi->new();
isa_ok($api, 'WWW::OpenAPIClient::AnlageEksApi');

#
# eks_api test
#
# uncomment below and update the test
#my $eks_api_year = undef; # replace NULL with a proper value
#my $eks_api_result = $api->eks_api(year => $eks_api_year);
