...
use_ok('WWW::OpenAPIClient::PaymentConditionApi');

my $api = WWW::OpenAPIClient::PaymentConditionApi->new();
isa_ok($api, 'WWW::OpenAPIClient::PaymentConditionApi');

#
# list_payment_conditions_api test
#
# uncomment below and update the test
#my $list_payment_conditions_api_result = $api->list_payment_conditions_api();
