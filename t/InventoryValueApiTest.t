...
use_ok('WWW::OpenAPIClient::InventoryValueApi');

my $api = WWW::OpenAPIClient::InventoryValueApi->new();
isa_ok($api, 'WWW::OpenAPIClient::InventoryValueApi');

#
# get_inventory_value_api test
#
# uncomment below and update the test
#my $get_inventory_value_api_result = $api->get_inventory_value_api();

#
# record_inventory_value_api test
#
# uncomment below and update the test
#my $record_inventory_value_api_result = $api->record_inventory_value_api();
