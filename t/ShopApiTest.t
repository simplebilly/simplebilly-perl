...
use_ok('WWW::OpenAPIClient::ShopApi');

my $api = WWW::OpenAPIClient::ShopApi->new();
isa_ok($api, 'WWW::OpenAPIClient::ShopApi');

#
# shop_editor_save test
#
# uncomment below and update the test
#my $shop_editor_save_body = undef; # replace NULL with a proper value
#my $shop_editor_save_result = $api->shop_editor_save(body => $shop_editor_save_body);
