...
use_ok('WWW::OpenAPIClient::DatevImportApi');

my $api = WWW::OpenAPIClient::DatevImportApi->new();
isa_ok($api, 'WWW::OpenAPIClient::DatevImportApi');

#
# datev_import_api test
#
# uncomment below and update the test
#my $datev_import_api_body = undef; # replace NULL with a proper value
#my $datev_import_api_result = $api->datev_import_api(body => $datev_import_api_body);
