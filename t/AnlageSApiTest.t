...
use_ok('WWW::OpenAPIClient::AnlageSApi');

my $api = WWW::OpenAPIClient::AnlageSApi->new();
isa_ok($api, 'WWW::OpenAPIClient::AnlageSApi');

#
# anlage_s_api test
#
# uncomment below and update the test
#my $anlage_s_api_year = undef; # replace NULL with a proper value
#my $anlage_s_api_result = $api->anlage_s_api(year => $anlage_s_api_year);
